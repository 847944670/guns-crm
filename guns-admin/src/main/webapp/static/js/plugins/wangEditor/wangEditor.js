...
// 原型
    Panel.prototype = {
        ...
        show: function show() {
            ...
            // focus 第一个 elem
            var $inputs = $container.find('input[type=text],textarea.tag');
            if ($inputs.length) {
                $inputs.get(0).focus();
            }
        ...
        _createPanel: function _createPanel(value) {
            ...
            var panel = new Panel(this, {
                ...
                tabs: [{
                    ...
                    title: '插入代码',
                    // 模板
                    tpl: '<div>\n                        <textarea.tag id="' + textId + '" style="height:145px;;">' + value + '</textarea.tag>\n                        <div class="w-e-button-container">\n                            <button id="' + btnId + '" class="right">\u63D2\u5165</button>\n                        </div>\n                    <div>',
                    // 事件绑定
                    events: [
                        // 插入代码
                        {
