...
@MapperScan(basePackages = {"com.stylefeng.guns.modular.*.dao","com.stylefeng.guns.modular.pm.*.dao","com.stylefeng.guns.modular.sm.*.dao","com.stylefeng.guns.multi.mapping"})
