...
public class ConstantFactory implements IConstantFactory {
	...
	@Override
	public String getKhhangy(Integer integer) {
		// TODO Auto-generated method stub
		return getDictsByName("客户行业", integer);
	}

	@Override
	public String getkhStar(Integer integer) {
		// TODO Auto-generated method stub
		return getDictsByName("重要程度", integer);
	}

	@Override
	public String getkhstare(Integer integer) {
		// TODO Auto-generated method stub
		return getDictsByName("销售阶段", integer);
	}

	@Override
	public String getfollwoType(Integer integer) {
		// TODO Auto-generated method stub
		return getDictsByName("跟进方式", integer);
	} 
